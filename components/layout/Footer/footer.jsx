                ...
                <div>
                  ...
                  <div className="input-group mb-3">
                    <input
                      ...
                      value={email}
                      className={`B2 ${styles.input} mb-4 w-75`}
                    ...
                    <button
                      type="button"
                      className="input-group-append arrow-right"
                  ...
                  <Link href="https://www.linkedin.com/company/beela-se/">
                    <a target="_blank">
                      <Image
                        ...
                        width={53}
                        height={33}
                        style={{ paddingLeft: "1.5rem", paddingRight: "0.6rem" }}
                      />
                    </a>
                  </Link>
                  ...
                  <Link href="https://www.linkedin.com/company/tech-fleet-community/mycompany/">
                    <a target="_blank">
                      <Image
                        ...
                        width={53}
                        height={33}
                        style={{ paddingLeft: "0.7rem", paddingRight: "0.1rem" }}
                      />
                    </a>
                  </Link>
