                    ...
                    <div className="row gy-4 gx-5 fnt-sml">
                        <div className="col-lg-6 col-md-6" id="our-mission">
                            ...
                            <div>
                                ...
                                <a
                                    href="https://www.linkedin.com/company/tech-fleet-community/mycompany"
                                    target="_blank"
                                    rel="noreferrer"
                                >
                ...
                <div className="d-flex flex-wrap   py-3 ">
                    <div className="nav col-md-4  list-unstyled d-flex">
                        <div className=" w-100 " id="join-community">
                            ...
                            <a href="https://www.linkedin.com/company/beela-se/" target="_blank" rel="noreferrer">
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    width="32"
                                    height="32"
                            ...
                            <a href="https://www.instagram.com/beela.se/" target="_blank" rel="noreferrer">
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    width="32"
                                    height="32"
                            ...
                            <br />
                            <br />
                            <span className="text-muted" id="copyright">
                                © 2022 Beela Stockholm, Sweden{" "}
                            </span>
                        </div>
                    </div>
                    <div className="col-md-4 " id="newsletter">
                        {/* <form>
              <label>
                <b>SIGN UP FOR BEELA’S NEWSLETTER</b>
              </label>
              <br />
              <input
                type="text"
