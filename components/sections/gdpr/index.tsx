  ...
  return (
    <SectionWrapper padding="main" color="GDPR_GRADIENT" maxWidth={1050}>
      ...
      <div className={styles.sectionWrap}>
        <h1 className="primary-berry" style={{ marginBottom: "1rem", marginTop: "7rem" }}>
          Privacy Notice
        </h1>
        <p className="B2" style={{ marginBottom: "2rem", lineHeight: "170%" }}>
          Last updated September 28, 2022
        </p>
        <p className="B1" style={{ marginBottom: "1rem", lineHeight: "170%" }}>
          This privacy notice for Beela, describes how and why we might collect, store, use, and/or
          share your information when you use our services such as when you:
        </p>
        <ul className="B1" style={{ lineHeight: "170%", marginLeft: "5%", marginBottom: "2rem" }}>
          <li>
            Visit our website at beela.se, or any website of ours that links to this privacy notice
          </li>
          <li>
            Engage with us in other related ways, including any donations, volunteering, mentorship
            or events
          </li>
        </ul>

        {/* QUESTIONS OR CONCERNS */}
        <h3 className="primary-berry" style={{ marginBottom: "0.5rem", lineHeight: "170%" }}>
          Questions or Concerns?
        </h3>
        <p className="B1" style={{ marginBottom: "2rem", lineHeight: "170%" }}>
          ...
          still have any questions or concerns, please contact us at Email: contact@beela.se
        </p>
      </div>
      ...
      <div className={styles.sectionWrap}>
        ...
        <h3 className="primary-berry" style={{ marginBottom: "0.5rem" }}>
        ...
        <p className="B1" style={{ marginBottom: "2rem", lineHeight: "170%" }}>
          The easiest way to exercise your rights is by emailing us at contact@beela.se. We will
          consider and act upon any request in accordance with applicable data protection law.
        </p>
      </div>

      {/* BEELA PRIVACY POLICY */}
      <div className={styles.sectionWrap}>
        <h1 className="primary-berry" style={{ marginBottom: "1rem" }}>
          Beela Privacy Policy
        </h1>
        <h2 className="primary-berry" style={{ marginBottom: "1rem" }}>
        ...
        <h4 className="primary-berry" style={{ marginBottom: "1rem" }}>
        ...
        <p className="B1" style={{ marginBottom: "2rem", lineHeight: "170%" }}>
          ...
          with your payment instrument. All payment data is stored by Swish and Stripe. You may find
          ...
          <Link href="https://assets.ctfassets.net/zrqoyh8r449h/7dh0Sa8HdSflT7FWUjcUqB/795504cec60010933e2d211036a86441/Swish_Privacy_Policy_eng_201019.pdf">
            <a target="_blank" className={styles.hyperlink}>
              Swish
            </a>
          </Link>
          ,
        ...
        <h3 className="primary-berry" style={{ marginBottom: "1rem" }}>
        ...
        <p className="B1" style={{ marginBottom: "1rem", lineHeight: "170%" }}>
          Like many non-profits, we also collect information through cookies and similar
          technologies.
        </p>
        <p className="B1" style={{ marginBottom: "1rem", lineHeight: "170%" }}>
      ...
      <div className={styles.sectionWrap}>
        <h2 className="primary-berry" style={{ marginBottom: "1rem" }}>
          What legal basis do we rely on to proccess your information?
        </h2>
        <p className="B1" style={{ marginBottom: "1rem", lineHeight: "170%" }}>
      ...
      <div className={styles.sectionWrap}>
        ...
        <p className="B1" style={{ marginBottom: "1rem", lineHeight: "170%" }}>
          In Short: In some regions, such as the EU, you have rights that allow you greater access
          to and control over your personal information. You may review, change, or terminate your
          account at any time.
        </p>
        <p className="B1" style={{ marginBottom: "1rem", lineHeight: "170%" }}>
          In some regions (like the EU), you have certain rights under applicable data protection
        ...
        <p className="B1" style={{ marginBottom: "1rem", lineHeight: "170%" }}>
          If you are located in Sweden, the contact details for the data protection authorities
      ...
      <div className={styles.sectionWrap}>
        ...
        <p className="B1" style={{ marginBottom: "1rem", lineHeight: "170%" }}>
          ...
          has been finalised. As such, we do not currently respond to DNT browser signals or any
      ...
      <div className={styles.sectionWrap}>
        ...
        <p className="B1" style={{ marginBottom: "1rem", lineHeight: "170%" }}>
          In Short: Yes, if youpersonal are a resident of California, you are granted specific
          rights regarding access to your information.
        </p>
        <p className="B1" style={{ marginBottom: "1rem", lineHeight: "170%" }}>
      ...
      <div className={styles.sectionWrap}>
        ...
        <p className="B1" style={{ marginBottom: "1rem", lineHeight: "170%" }}>
          ...
          Officer (DPO) by email at contact@beela.se, or by post to:
        </p>
        <p className="B1" style={{ marginBottom: "1rem", lineHeight: "170%" }}>
          Beela
        </p>
      ...
      <div className={styles.sectionWrap}>
        ...
        <p className="B1" style={{ marginBottom: "6rem", lineHeight: "170%" }}>
          ...
          request to review, update, or delete your personal information, please submit email beela
          us at contact@beela.se.
        </p>
      </div>
      <Link href="/donate">
        <a className="h4">
