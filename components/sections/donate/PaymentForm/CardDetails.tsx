    ...
    <div>
      <form id="payment-form" onSubmit={handleSubmit}>
        ...
        <div className="form-group">
          ...
          <input id="FirstName" className="form-control" type="text" onChange={handleFirstName} />
        </div>
        <div className="form-group">
          <label htmlFor="LastName">Last Name</label>
          <input id="LastName" className="form-control" onChange={handleLastName} type="text" />
        </div>
        {/* <div className="form-group">
