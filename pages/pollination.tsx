              ...
              <div className="card-deck d-flex flex-row " id="card-deck-steps-hex">
                <div className="card m-5 " id="card-m5-steps-hex">
                  <div className="card-body">
                    ...
                    <p className="card-text">Getting to know your mentor</p>
                  </div>
                </div>
                <div className="card m-5 " id="card-m5-steps-hex-1">
                  <div className="card-body">
                    ...
                    <p className="card-text">Refining Goals</p>
                  </div>
                </div>
                <div className="card m-5 " id="card-m5-steps-hex">
                  <div className="card-body">
                    ...
                    <p className="card-text">Completing Goals</p>
                  </div>
                </div>
                <div className="card m-5" id="card-m5-steps-hex-1">
                  <div className="card-body">
                    ...
                    <p className="card-text">Finishing up</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="container-fluid justify-content-center overflow-hidden">
            ...
            <div className=" row border text-center h-75">
              <div className="col d-flex flex-column align-items-center  p-5" id="CTA">
                ...
                <div className="p-3">
                  <p id="header-text">
                    Beela and our team of mentors are happy to help you on your journey into Tech!
