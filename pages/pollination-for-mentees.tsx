      ...
      <main>
        ...
        <div>
          ...
          <div className="myCarousel">
            ...
            <p>
            When I arrived in Stockholm, I was new to Sweden and looking for a tech job for the first time, I felt insecure, lost and unmotivated, until I joined the Beela mentorship program as a mentee, which helped me better understand the Swedish job market and feel accompanied in this process and soon after that I found a job! Now I am a mentor in Beela and I want to continue participating as much as I can in this wonderful network. </p>
          </div>
        </div>
      </Carousel>
              ...
              <Container className="home-pollination__spacer">
                ...
                <Row xs={1} md={2} className="m-4 align-items-center justify-content-center">
                  ...
                  <Col
                    ...
                    className="p-2"
                  >
                    <h3 className="no_name_37" style={{ textAlign: 'start' }}>Newsletter</h3>
                    <p className="m-0 B1" style={{ maxWidth: '268px', textAlign: 'start' }}>
