              ...
              <Accordion defaultActiveKey="0" className="my-5">
                ...
                <Accordion.Item eventKey="2">
                  <Accordion.Header className="mb-0 no_name_37">
                    <span className="mb-0 no_name_37">
                      {" "}
                      What qualifications will my mentor have?
                    </span>
                  </Accordion.Header>
                  <Accordion.Body className="B1">
          ...
          <Carousel showArrows={true} showThumbs={false} showStatus={false} autoPlay={false}>
            <div>
              ...
              <div className="myCarousel">
                ...
                <p>
                  ...
                  needs. It&apos;s also exciting to see the programme grow, adapt and experiment
                  with new ideas such as getting involved in real-life projects to practice our new
                  skills.
                </p>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="myCarousel">
                ...
                <p>
                  When I arrived in Stockholm, I was new to Sweden and looking for a tech job for
                  the first time, I felt insecure, lost and unmotivated, until I joined the Beela
                  mentorship program as a mentee, which helped me better understand the Swedish job
                  market and feel accompanied in this process and soon after that I found a job! Now
                  I am a mentor in Beela and I want to continue participating as much as I can in
              ...
              <Container className="home-pollination__spacer">
                <Row xs={1} md={2} className="m-4 align-items-center justify-content-center">
                  ...
                  <Col xs={{ order: 2 }} sm={10} md={{ span: 6 }} lg={6} xl={5} className="p-2">
                    ...
                    <p className="m-0 B1" style={{ maxWidth: "268px", textAlign: "start" }}>
                      Ask questions, network, and stay up-to-date about upcoming events. We&apos;re
                      an inclusive bunch, and we&apos;d love to have you!
                    </p>
                    <div className="pt-3 left-center-text">
                      <Link href="https://beela.slack.com/join/shared_invite/zt-12kargaye-5R2bP0qwqNpFwPiiDAiwQQ#/shared-invite/email">
                        <a target="_blank">
