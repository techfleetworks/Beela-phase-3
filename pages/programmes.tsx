...
const Programmes: NextPage = () => {
                ...
                <div className="row" id="hero-container">
                    <div className="col py-4 px-5 m-5">
                        ...
                        <div className="container">
                            ...
                            We offer different programmes to fit your needs depending on where you are in your journey.
                            </p>
                            <p className="B1">
                                <ul>
                                    <li> Our <b>Pollination Mentoring Programme <br/> </b>connects you with mentors for 1-on-1 guidance.</li>
                                    <li>Find <b>Projects</b> and <b>apprenticeships</b> to hone your skills in the #announcements, #job-leads, and #projects-pro-bono Slack channels</li>
                                </ul>
                            </p>
                        </div>
                        </div>
 ...
 <section id="section-pollination">
              ...
              <Container className="home-pollination__spacer">
                ...
                <Row xs={1} md={2} className="m-4 align-items-center justify-content-center">
                  ...
                  <h4 className="no_name_37 text-start">How can we help you grow?</h4>
                    <p className="m-0">
                    Unsure about expectations for switching careers in Sweden? Or eager to share your experience?Our free programme offers 1-on-1 mentorship, along with events and workshops to help mentees get into tech. 
                    </p>
                  </Col>
                </Row>
        ...
        <Image src="/avatar.png" alt="About Beela" width={500} height={340} />
        <h2 className="no_name_37">We are growing with you</h2>
        <div className="container" id="growing-p">
        <p className="B1" >Responding to the needs of our community is important to us. We are working hard to build programmes to best fit your needs.</p>
        </div>
        <h4 className="no_name_37 " >Apprenticeship Programme</h4>
        <div className="d-flex justify-content-center text-center">
        <p className="B1 " id="growing-apprentice">Beela is in the process of partnering with companies to provide the opportunity to work on real-world projects. Stay tuned for updates on Slack.</p>
        </div>
        <Link href="/#"><a><button type="button" className="btn  button slack-btn">Continue to Slack</button></a></Link>
